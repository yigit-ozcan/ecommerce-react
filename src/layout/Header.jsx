    ...
    <header className="w-full flex flex-col">
      ...
      <div className="flex justify-between items-center px-8 py-8 md:px-12 md:py-6 bg-white md:bg-[#F9F9F9]">
        ...
        <div className="flex items-center gap-6">
          {/* 🔥 LOGIN / USER */}
          <div className="hidden md:flex items-center gap-3 text-[#23A6F0] font-medium text-[18px]">
            {user && user.email ? (
              <>
                <Gravatar
                  email={user.email}
          ...
          >
            <span className="h-[3px] bg-[#252B42] w-8" />
            <span className="h-[3px] bg-[#252B42] w-6 ml-2" />
            <span className="h-[3px] bg-[#252B42] w-4 ml-4" />
          </div>
        </div>
      </div>
      ...
      {/* ===== MOBILE MENU ===== */}
      {menuOpen && (
        <div className="md:hidden w-full bg-white flex flex-col items-center py-10 gap-10 border-t">
          <div className="flex flex-col items-center gap-8 text-[36px] text-[#737373]">
            <span>Home</span>
            <span>Shop</span>
            <span>About</span>
            <span>Blog</span>
          ...
          {/* 🔥 MOBILE LOGIN */}
          <div className="flex items-center gap-3 text-[#23A6F0] text-[36px]">
            {user && user.email ? (
              <>
                <Gravatar
                  email={user.email}
